...
import { User, Student, StudentFormData } from "@/types";
...
export default function EditStudent({ id, user }: EditStudentProps) {
  ...
  const {
    ...
    onSuccess: (data) => {
      ...
      form.reset({
        name: data.name,
        age: data.age,
        class: data.class as "Nursery" | "LKG" | "UKG",
        parentContact: data.parentContact || "",
        learningAbility: data.learningAbility as "Talented" | "Average" | "Slow Learner",
        writingSpeed: data.writingSpeed as "Speed Writing" | "Slow Writing" | "N/A" || "N/A",
        notes: data.notes || "",
  ...
  const updateMutation = useMutation({
    mutationFn: (data: Partial<StudentFormData>) => updateStudent(studentId, data),
    onSuccess: () => {
      toast({
        title: "Success",
  ...
  // If student was not found or user doesn't have access
  if (isError) {
    return (
      <div className="py-6">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card>
            <CardContent className="py-10 text-center">
              <p className="text-red-500">Failed to load student information. Student may not exist or you don't have access.</p>
        ...
        {isLoading ? (
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Update {student?.name}'s information and class assignment
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Form {...form}>
